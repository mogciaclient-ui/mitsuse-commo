...
export default function SurveyPage() {
  ...
  return <main className="survey-page">
    <section className="survey-card">
      ...
      <div className="survey-intro"><span className="survey-eyebrow">QUESTIONNAIRE</span><h1>いい麺亭から<br />うれしいお知らせをお届けします</h1><p>あなたに合ったお知らせをお届けするため、<br />簡単なアンケートにご協力ください。</p>{lineDisplayName ? <span className="line-welcome">{lineDisplayName}さんとして回答します</span> : <span className="line-welcome">LINEログインを確認しています…</span>}</div>
