...
export function SurveyOverview({ responseCount }: { responseCount: number }) {
  const questions = [
    { number: "01", title: "購入店舗", detail: "販売店と店舗名を選択", required: true },
    { number: "02", title: "生年月日", detail: "年・月・日を入力", required: true },
    { number: "03", title: "いいもの三瀬へひとこと", detail: "ご意見やご要望を自由入力", required: false },
  ];
